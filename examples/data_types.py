...
print(tablefmt.generate_table(iteralbe_of_iterables))

np_2d_array = np.array([[1, 2, 3, 4],
                        [5, 6, 7, 8]])
print("Data type: NumPy 2D array")
print(np_2d_array)
print(tablefmt.generate_table(np_2d_array))
...
print(np_rec_array)
print(tablefmt.generate_table(np_rec_array))
...
print(tablefmt.generate_table(pandas_dataframe))
...
print(tablefmt.generate_table(dict_of_iterables))
